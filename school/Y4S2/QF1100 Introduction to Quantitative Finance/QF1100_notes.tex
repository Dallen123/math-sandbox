...
\begin{proposition}[Portfolio Variance]
...
Now,we go into \textit{Mean-Variance Analysis}

\subsubsection{Mean-Variance Analysis}

The \textit{mean-variance} analysis aims to ask the question: \textit{As $\alpha$ varies, how will $\mu_p$ and $\sigma_p$ change?}
